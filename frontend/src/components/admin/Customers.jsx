...
const getColor = (name) =>
  avatarColors[(name || "A").charCodeAt(0) % avatarColors.length];
const initials = (name) =>
  (name || "User")
    .split(" ")
    .map((n) => n[0])
...
const Customers = () => {
  ...
  useEffect(() => {
    ...
    socket.on("user_created", () => getUsers());
  ...
  const toggleAccountStatus = async (user) => {
    ...
    setUsers(prev => prev.map(u => 
      String(u._id) === String(user._id) ? { ...u, isActive: newStatus } : u
    ));
        ...
        >
          <div style={{ minWidth: "850px" }}>
            ...
            <div
              style={{
                display: "grid",
                gridTemplateColumns: "2fr 1.2fr 100px 100px 100px 60px",
                padding: "10px 20px",
                borderBottom: "1px solid #f0f7ff",
              }}
            >
              {["CUSTOMER", "JOINED", "ROLE", "ACCOUNT", "PRESENCE", ""].map((h, i) => (
                <span
                  key={i}
                  style={{
                    fontSize: "11px",
                  ...
                  >
                    ...
                    <span
                      style={{
                        fontSize: "12px",
                        fontWeight: 600,
                        color: row.isActive ? "#16a34a" : "#ef4444",
                    ...
                    <span
                      style={{
                        ...
                        fontSize: "12px",
                        fontWeight: 500,
                        color: row.isOnline ? "#2563eb" : "#9ab0be",
                      }}
                    >
                      <div style={{ width: 6, height: 6, borderRadius: "50%", background: row.isOnline ? "#2563eb" : "#9ab0be" }} />
                    ...
                    <button
                      ...
                      style={{
                        ...
                        fontWeight: 700,
                        border: "1px solid",
                        borderColor: row.isActive ? "#ef4444" : "#16a34a",
                        color: row.isActive ? "#ef4444" : "#16a34a",
